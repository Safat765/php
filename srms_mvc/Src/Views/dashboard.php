...
<body class="bg-body-tertiary">
  ...
  <main class="col-sm-10 bg-body-tertiary" id="main">
    <!-- NavBar -->
        <nav class="navbar sticky-top navbar-expand-lg border-bottom bg-body-tertiary">
          <div class="container-fluid">
            ...
            <?php
              ...
              ?>
            <h2><a class="navbar-brand" href="../dashboard.php">SRMS</a></h2>
            <?php
              } elseif ($_SERVER['REQUEST_METHOD'] == "GET") {
            ?>
            <h2><a class="navbar-brand" href="../Views/dashboard.php">SRMS</a></h2>
            <?php
              } else {
            ?>            
            <h2><a class="navbar-brand" href="../dashboard.php">SRMS</a></h2>
        ...
        <div class="ps-3 pe-3">
          <div style="
              background-image: url('https://png.pngtree.com/thumb_back/fh260/background/20230612/pngtree-cartoon-students-celebrating-graduation-image_2900390.jpg'); /* Replace with your image URL */
              ...
              text-shadow: 2px 2px 4px hsla(0, 1.80%, 11.20%, 0.50); /* Adds a shadow to the text for better contrast */
              border-radius: 10px; /* Optional: Adds rounded corners */">
            <h3 class="welcome" style="
                font-family: 'Poppins', sans-serif;
                font-size: 2rem;
                font-weight: 700;
                color:hsl(0, 75.00%, 98.40%);
                text-align: center;
                margin-top: 20px;
                text-shadow: 2px 2px 4px#100f0f;">
                Welcome to dashboard of Student Result Management System
            </h3>
            <br>
            <?php
                if ($_SESSION['user_type'] === 1) {
